...
############################################
        ...
        try:
            ...
            print(bName + "Kitap adi belirtilmemis")
        print(bName)
        ...
        try:
            ...
            print(pubDate + "Yayınlanma tarihi belirtilmemiş")
        print(pubDate)
        ...
        try:
            ...
            print(bPrice+"Kitabin fiyati belirtilmemis")
        print(bPrice)
        ...
        try:
            ...
            print(descOfBook+"Kitabin tanimi belirtilmemis")
        print(descOfBook)
        ...
        try:
            ...
            print(nPage + "Sayfa Sayisi belirtilmemis")
        print(nPage)
        try:
            ###############################333
            #yazar
            ...
            print(wRiter+"yazar belirtilmemis")
        print(wRiter)
        try:
            ######################################
            ##isbn
        ...
        try:
            ...
            print(bookEdition+"basim sayisi belirtilmemiş")
        print(bookEdition)
